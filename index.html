...
<head>
  ...
  <title>Weather-Blast</title>
  <link rel="stylesheet" href="style.css" />
  <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
  <script src="https://apis.mappls.com/advancedmaps/api/a9ba6e316849b4c62fe0c23d2ab10945/map_sdk?layer=raster&v=3.0&callback=initMap" defer async></script>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" />
</head>
<body>
  <!-- Back to Top Button -->
  <button id="backToTopBtn" onclick="scrollToTop()" title="Back to Top" aria-label="Scroll to top">
    <i class="fas fa-arrow-up"></i>
  </button>

  <header>
    <h1>{Weather-Blast}</h1>
    <button id="dark-mode" aria-label="Toggle dark mode">☀️</button>
  </header>

  <div class="up-container">
    <div class="card">
      <p class="first">ENTER YOUR LOCATION</p>
      <input type="text" id="city-input" placeholder="Enter city, State name or ZIP Code" oninput="autoComplete()" aria-label="Enter city name" />
      <div id="suggestion-box">
        <div id="suggestion-0" class="suggestion" tabindex="0"></div>
        <div id="suggestion-1" class="suggestion" tabindex="0"></div>
        <div id="suggestion-2" class="suggestion" tabindex="0"></div>
        <div id="suggestion-3" class="suggestion" tabindex="0"></div>
        <div id="suggestion-4" class="suggestion" tabindex="0"></div>
      </div>
      <button onclick="getWeatherByCity()" aria-label="Search weather">Search</button>
      <p class="or">OR</p>
      <button onclick="getWeatherByLocation()" id="locate" aria-label="Use current location">Use Current Location</button>
    </div>
  ...
  <div id="weather-alert-box" style="display:none;"></div>
  ...
  <div id="recent-searches">
    ...
    <button id="reset-searches-btn" aria-label="Reset search history">Clear Search History</button>
  </div>

  <!-- Nearby Cities Section -->
  <section id="nearby-cities">
    <h2>Nearby Cities Weather</h2>
    <div id="nearby-loading" style="display: none;" aria-live="polite">
      <div class="spinner"></div>
      <p>Loading nearby cities...</p>
    </div>
    <div id="nearby-error" style="display: none;" role="alert"></div>
    <div class="nearby-cities-container">
